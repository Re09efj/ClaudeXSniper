"""
generate_config.py
Arrow Lake (Intel Core Ultra 9 285K) の Sniper 設定ファイルを
戦略・スレッド数ごとに動的生成する。

トポロジ (物理):
  CPU  0- 3 : P-core, 4.0 GHz, Node0
  CPU  4- 7 : E-core, 1.0 GHz, Node0
  CPU  8-11 : P-core, 4.0 GHz, Node1
  CPU 12-15 : E-core, 1.0 GHz, Node1
...
def generate_config(
    ...
    """
    Arrow Lake 設定ファイルを生成して output_path に書き込み、パスを返す。
    """
    ...
    cfg = f"""\
# Arrow Lake (Core Ultra 9 285K) - strategy={strategy}, threads={num_threads}
