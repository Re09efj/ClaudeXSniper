...
def find_comm_csv(workload: str, bench_class: str, num_threads: int) -> str:
    ...
    base = "/home/hiragahama/ClaudeXSniper/Data/comm_matrices"
    if bench_class == "S":
        pattern = f"{base}/{workload}_{num_threads}TH_*.comm.csv"
    else:
        pattern = f"{base}/{workload}_{bench_class}_{num_threads}TH_*.comm.csv"
